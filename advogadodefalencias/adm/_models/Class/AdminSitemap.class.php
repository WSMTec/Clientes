...
class AdminSitemap {
    ...
    public function ExeDelete($CategoryId) {
        ...
        if (!$read->getResult()):
            ...
            $this->Result = true;
            $this->Error = ["A <b>{$page_name}</b> foi removida com sucesso do sistema!", 'green', 'lnr lnr-smile', 4000];
        endif;
    }
    ...
    private function setName() {
        ...
        if ($readName->getResult()):
            $this->Result = false;
            $this->Error = ["A <b>url {$page_name}</b> já existe em nossa base de dados!", 'blue', 'lnr lnr-warning', 4000];
        endif;
    }
    ...
    private function Update() {
        ...
        if ($Update->getResult()):
            $this->Result = true;
            $this->Error = ["<b>Sucesso:</b> A url {$this->Data['page_name']} foi atualizada no sistema!", 'green', 'lnr lnr-smile', 4000];
        endif;
    }
