...
//        var_dump($ReadPost->getResult());
        ...
        elseif (!is_null($this->Users)):
            ...
            foreach ($Arr as $k => $item) {
                ...
                $Contato['Mensagem'] = "<img src='" . HOME . "/uploads/" . (!empty($post_cover) ? $post_cover : 'blog/logo3.png') . "' width='50%'><br><br>" . $post_content;
                ...
                $Contato['RemetenteEmail'] = "contato@advogadodefalencias.com.br";
            ...
            if ($Bool) {
                ...
                $this->Error = ["Erro: os e-mails não foram enviados!", "green", "lnr lnr-smile", 4000];
                $this->Result = false;
                return;
            }
        else:
