...
$Read = new Read;
$Read->FullRead("SELECT * FROM tb_posts INNER JOIN tb_categories ON category_id = post_category");
$Rows = $Read->getRowCount();
$TotalRows = $Rows;

//PESQUISA
$Query = "SELECT * FROM tb_posts INNER JOIN tb_categories ON category_id = post_category";
...
foreach ($Read->getResult() as $dt):
    ...
    if ($post_cover != '') {
        ...
        $img = Check::Image('uploads/blog/logo3.png', $post_title, 80, 30, true);
    }
