...
//        $exceptions = array('de', 'di', 'do', 'da', 'dos', 'das', 'dello', 'della',
...
//    }
    ...
    public static function Situacao($Data) {
        if ($Data == 'U') {
            $Data = "Situação Unificado";
            return $Data;
        }
        if ($Data == 'C') {
            $Data = "Situação Cancelada";
            return $Data;
        }
        if ($Data == 'Q') {
            $Data = "Situação Quitada";
            return $Data;
        }
        if ($Data == 'A') {
            $Data = "Situação em Aberto";
            return $Data;
        }
        if ($Data == 'P') {
            $Data = "Situação Pedido";
            return $Data;
        }
    }

    public static function ValorBr($Data) {
        return number_format($Data, 2, ',', '.');
    }

    public static function DadosV($Data) {
        $Data = (!empty($Data) ? $Data : "Vazio");
        return $Data;
    }
    ...
    public static function RealDB($String) {
        $String = (empty($String) ? '0' : str_replace(',', '.', str_replace('.', '', $String)));

        return $String;
    }

    public static function OnlyVl($String) {
        $String = preg_replace("/[^0-9\.\,]/", "", $String);
        $String = (empty($String) ? '0' : str_replace(',', '.', str_replace('.', '', $String)));
        return $String;
    }

    public static function OnlyPorcentR($String) {
        $String = str_replace(".", ",", $String) . "%";
        return $String;
    }

    public static function OnlyPorcent($String) {
        $String = str_replace("%", "", $String);
        $String = str_replace(",", ".", $String);
        return $String;
    }
