...
<div class="main_ebook_ebook">
    ...
    <div class="content_flex">
        <article class="article_ebook">
            <div class="img_ebook">
                <img alt="<?= $ebook_title; ?>" title="<?= $ebook_title; ?>" src="<?= HOME; ?>/tim.php?src=<?= HOME; ?>/uploads/<?= ($ebook_cover ? $ebook_cover : 'blog/6.jpg'); ?>&w=460" />
            ...
            <div class="form_ebook_div">
                <div class="form_ebook">
                    <div class="header_form">
                        <h2>Faça o download grátis do seu eBook aqui!</h2>
                        <p>
                            <!--Basta preencher o fomulário abaixo:-->
                            Basta preencher o fomulário abaixo para recebe-lo em seu email.
                        </p>
                    </div>
                    <form action="<?= HOME . '/confirm' ?>" class="" method="post">
                        <div class="">
                            <input name="new_name" required="" type="text" placeholder="Nome">
                            <input name="new_email" required type="text" placeholder="Email">
                            <input name="new_fone" required type="text" placeholder="Telefone">
                            <input name="new_company" type="text" placeholder="Empresa">
                            <input name="new_type" type="hidden" value="ebook">
                            <input name="ebook" type="hidden" value="<?= $ebook_name; ?>">
                            <input name="SendEbookForm" type="hidden">
                            <button>Receber eBook</button>
                        </div>
                    </form>
                </div>  
            </div>  
    ...
    <!--    <div class="ebook_coments">
            <div class="like_fb">
                <div class="fb-like" data-href="https://<?= $ebook_name; ?>" data-width="" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
            </div>  
            <div class="coments_fb">
                <div class="fb-comments" data-href="https://<?= $ebook_name; ?>" data-width="600" data-numposts="10"></div>
            </div>
        </div>-->
</div>
