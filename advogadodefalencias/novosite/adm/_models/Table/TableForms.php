...
foreach ($Read->getResult() as $dt):
    ...
    $SubData[] = ""
            . "<div>"
            . "<button name='btn-href[]' data-href='?exe=forms/update&posts={$id_cli}' type='button' class='btn btn-primary btn-xs btn-left'><span class='lnr lnr-printer'></span></button> "
//            . "<button name='btn-modal[]' data-function='forms-delete' data-name='forms' value='{$id_cli}' type='button' class='btn btn-danger btn-xs btn-rigth'><span class='lnr lnr-trash'></span></button>"
            . "</div>";
    $Data[] = $SubData;
endforeach;
