...
<div class="app_modal" data-modalclose="true">
    ...
    <div class="app_modal_box app_modal_requests">
        ...
        <form data-class=".form_product" autocomplete="nope" autocomplete="none" method="post" class="form_product form_reset"
            ...
            <input type="hidden" name="action" value="requests-item"/>
            ...
            <div class="row-f">
                <div class="row-m">
                    ...
                    <input autocomplete="off" class="empty_field input_quant" name="QUANT" type="text" required/>
                </div>
                <div class="row-m">
                    <label>
                        Comissão
    ...
    <div class="app_modal_box app_modal_up_requests">
        ...
        <form data-class=".form_update_product" autocomplete="nope" autocomplete="none" method="post"
              ...
              action="../source/App/Search.php">
            <input type="hidden" class="input_action" name="action" value="requests-update-item"/>
