$(function () {
    ...
    HOME = "https://www.advogadodefalencias.com.br/";
    CaptVisitor();
    CaptEmail();

    var pages = location.href.substring(location.href.lastIndexOf('/') + 1);
//    alert(pages);
//    alert(page);
//    console.log(pages);
    if (!pages) {
...
//                $('.class_relative').css("background-color", "#22409a");
//                $('.cbp-af-header').css("background-color", "#0575E6");
//                $('.class_relative').css("height", "100px");
                $('.nav_one').css("display", "none");
                $('.logo img').css("width", "146px");
            } else {
//                $('.class_relative').css("background-color", "");
//                $('.cbp-af-header').css("background-image", "linear-gradient(to top, rgba(0, 0, 0, 0), rgb(0, 0, 0))");
//                $('.class_relative').css("height", "auto");
                $('.nav_one').css("display", "block");
                $('.logo img').css("width", "440px");
            }
        });
    }
...
//        alert(1);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.erro === true) {
                    $("#" + data.notify).html(data.number + '<img src="https://www.advogadodefalencias.com.br/themes/mazzilli/images/artigos/like.png" width=""/></a>');
    ...
    function jQueryForm(action, form, codigo = null) {
        ...
        form.ajaxSubmit({
            ...
            beforeSubmit: function () {
                $('.button_submit_' + action).attr("disabled", "disabled").addClass('form-btn-create').html("<img src='//advogadodefalencias.com.br/images/carregando.gif' width='15'/> Carregando");
            },
