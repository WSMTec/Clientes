...
class AdminConfig {
    ...
    public function ExeCreate(array $Data) {
        ...
        if (in_array('', $this->Data)):
            $this->Result = false;
            $this->Error = ['<b>Erro ao cadastrar, preencha todos os campos!', 'blue', 'lnr lnr-warning', 4000];
        else:
            $this->setData();
            $this->setName();
            $this->Create();
    ...
    public function ExeUpdate($CategoryId, array $Data) {
        ...
        $Update = new Update;
        $Update->ExeUpdate(self::Entity, $this->Data, "WHERE config_id = :catid", "catid={$this->CatId}");
        if ($Update->getResult()):
            $this->Result = true;
            $this->Error = ["Os dados foram atualizados no sistema!", 'green', 'lnr lnr-smile', 4000];
        endif;
    }
