...
class AdminEbook {
    ...
    public function ExeCreate(array $Data) {
        ...
        if (in_array('', $this->Data)):
            $this->Error = ["Erro ao cadastrar: Para criar um eBooks, favor preencha todos os campos!", "blue", "lnr lnr-warning", 4000];
            $this->Result = false;
        else:
            $this->setData();
            $this->setName();
    ...
    public function ExeUpdate($PostId, array $Data) {
        ...
        if (in_array('', $this->Data)):
            $this->Error = ["Para atualizar este eBook, preencha todos os campos ( Foto, pdf, Pop-up Capa não precisa ser enviada! )", "blue", "lnr lnr-warning", 4000];
            $this->Result = false;
        else:
            $this->setData();
            $this->setName();
    ...
    public function ExeDelete($PostId) {
        ...
        if (!$ReadPost->getResult()):
            $this->Error = ["O eBook que você tentou deletar não existe no sistema!", "red", "lnr lnr-warning", 4000];
            $this->Result = false;
        else:
            ...
            $this->Error = ["O post <b>{$PostDelete['ebook_title']}</b> foi removido com sucesso do sistema!", "green", "lnr lnr-smile", 4000];
            $this->Result = true;
...
//    
    ...
    private function Create() {
        ...
        if ($cadastra->getResult()):
            ...
            $this->Error = ["O eBook {$this->Data['ebook_title']} foi cadastrado com sucesso no sistema!", "green", "lnr lnr-smile", 4000];
    ...
    private function Update() {
        ...
        $Update->ExeUpdate(self::Entity, $this->Data, "WHERE ebook_id = :id", "id={$this->Post}");
        if ($Update->getResult()):
            $this->Error = ["O eBook <b>{$this->Data['ebook_title']}</b> foi atualizado com sucesso no sistema!", "green", "lnr lnr-smile", 4000];
            $this->Result = true;
        endif;
    }
