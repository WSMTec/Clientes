...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/png" href="<?= INCLUDE_PATH; ?>/images/favicon.png">
    ...
    <body>
        <main class="container">
            <section class="box">
                ...
                <p>
                    Painel administrativo Advocacia, realize o login para ter acesso.
                </p>
                <?php
                $login = new Login(0);
                if ($login->CheckLogin()):
                ...
                if (!empty($dataLogin['AdminLogin'])):
                    ...
                    if (!$login->getResult()):
                        Erro($login->getError()[0], $login->getError()[1]);
                    else:
                        header('Location: painel.php');
                    endif;
                endif;
                ...
                if (!empty($get)):
                    if ($get == 'restrito'):
                        Erro('<b>Oppsss:</b> Acesso negado. Favor efetue login para acessar o painel!', ALERT);
                    elseif ($get == 'logoff'):
                        Erro('<b>Sucesso ao fazer logoff:</b> Sua sessão foi finalizada. Volte sempre!', ACCEPT);
                    endif;
                endif;
                ?>
