...
foreach ($Read->getResult() as $dt):
    ...
    $SubData[] = ""
            . "<div>"
            . "<button name='btn-href[]' data-href='?exe=uploads/update&uploads={$audio_id}' type='button' class='btn btn-primary btn-xs btn-left'><span class='lnr lnr-eye'></span></button> "
